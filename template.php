 ...
 */
function architect_theme($existing, $type, $theme, $path) {
  $theme = array();
 ...
 */
function architect_preprocess_page(&$variables) {
  global $user;
 ...
 */
function architect_preprocess_html(&$variables) {
  global $user;
 ...
 */
function architect_preprocess_block(&$variables, $hook) {
 ...
 * For footer.tpl.php
 */
function architect_preprocess_footer(&$variables) {
  $variables['footer_left'] = block_get_blocks_by_region('footer_left');
  $variables['footer_center'] = block_get_blocks_by_region('footer_center');
 ...
 * For header.tpl.php
 */
function architect_preprocess_header(&$variables) {
 ...
 */
function architect_css_alter(&$css) {
 ...
 * Login and a password recovery pages.
 */
function architect_form_user_login_block_alter(&$form, &$form_state) {
...
function architect_form_user_login_alter(&$form, &$form_state) {
  $form['name']['#title_display'] = 'invisible';
  $form['name']['#attributes'] = array('placeholder' => 'Логин');
...
function architect_form_user_pass_alter(&$form, &$form_state) {
  $form['name']['#title_display'] = 'invisible';
 ...
 */
function architect_process_html(&$variables) {
 ...
 */
function architect_process_page(&$variables, $hook) {
  if (module_exists('color')) {
